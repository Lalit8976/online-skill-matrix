 ...
 */
public class View_Ques_List extends HttpServlet 
{
            ...
            throws ServletException, IOException
    {
        ...
        try 
        {
            ...
            out.println("<br><div style='width:900px;height:450px;background-color:cyan;'>"
                    + "<div style='width:250px;height:450;background-color:#CCCCCC;float:left;text-align:left;"
                    ...
                    + "<ul type=box &raquo;>"
                        ...
                        + "<br><li><a href='View_Feedback' class='style1'>View Feedback&nbsp;&nbsp;&raquo;&raquo;</a></li>"
                          + "</ul></div>"
                    + "<div style='width:900px;height:450px;background-color:#CCCCCC;'></div>"
                    + "</div>");
